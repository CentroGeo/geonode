...
urlpatterns = [
    ...
    path('public/', views.mviewer_public, name='mviewer_public'),
    url(r'^create/$', views.mviewer_create, name='mviewer_create'),
    url(r'^header/(?P<mv_id>\d+)$', views.upload_mviewer_header, name='upload_mviewer_header'),
    url(r'^editar_encabezado/(?P<header_id>\d+)$', views.edit_mviewer_header, name='edit_mviewer_header'),
    ...
    url(r'^topic_text_create/(?P<mv_id>\d+)$', views.create_text_topic, name='create_text_topic'),
    url(r'^topic_text_update/(?P<topictext_id>\d+)$', views.update_text_topic, name='update_text_topic'),
    url(r'^topic_text_remove/(?P<topictext_id>\d+)$', views.delete_text_topic, name='delete_text_topic'),
    url(r'^topic_text_item_create/(?P<topictext_id>\d+)$', views.create_text_topic_item, name='create_text_topic_item'),
    url(r'^topic_text_item_update/(?P<topictextitem_id>\d+)$', views.update_text_topic_item, name='update_text_topic_item'),
    url(r'^topic_text_item_remove/(?P<topictextitem_id>\d+)$', views.delete_text_topic_item, name='delete_text_topic_item'),
    ...
    url(r'^sort_text_topic/$', views.sort_text_topic, name='sort_text_topic'),
    url(r'^sort_text_topic_element/$', views.sort_text_topic_item, name='sort_text_topic_item'),
]
