...
class Microsite(models.Model):
    ...
    group = models.ForeignKey(GroupProfile, verbose_name = "Grupo", on_delete=models.CASCADE)
...
class Category(models.Model):
    ...
    content_modal = RichTextField(verbose_name="Contenido",
                              help_text='Aquí puedes responder tu pregunta',
