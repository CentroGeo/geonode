...
INPUT_DIR = '/home/israel/Documentos/shapefiles/test_data/'
...
class TabularTest:
    ...
    def __init__(self, base_url="http://localhost:8000"):
        ...
        self.shp_layer_upload_url = self.base_url + '/upload/'
...
if __name__=='__main__':
    ...
    #layer = tr.add_shapefile_layer(INPUT_DIR, 'estados2010')
    ...
    # dt = tr.upload_csv_file('TablaPrueba', '/home/israel/Documentos/tabletojoin.csv')
    ...
    # Type Mismatch 
    join_props = {'layer_typename': 'geonode:estados2010', 'table_name': 'tabla', 'table_attribute': 'cve_ent', 'layer_attribute': 'CVEENT'}
