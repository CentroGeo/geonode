				...
				return {
					...
					onOk: function()
					{
						...
						if ( this.getContentElement( 'youtubePlugin', 'txtEmbed' ).isEnabled() )
						{
							...
							if ( this.getContentElement( 'youtubePlugin', 'chkFW' ).getValue() === true )
							{
								styleClass = 'iframe-fw';
							}
							...
							if ( this.getContentElement( 'youtubePlugin', 'chkOlderCode' ).getValue() === true )
							{
								...
								content += '<iframe class="'+ styleClass +'" width="' + width + '" height="' + height + '" src="' + url + '" ' + responsiveStyle;
