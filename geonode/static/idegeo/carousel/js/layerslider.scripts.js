...
jQuery( '#layerslider' ).layerSlider({
	...
	skin					: 'v5',
	skinsPath				: 'static/carousel/css/skins/',
...
(function ($) {
	...
	$(document).ready(function ($) {
		...
		var json = [ 
			...
			{ 'layer': '#layerslider .mm-slider-img-1', 'valuexin': '0', 'valueyin': '0' },
			{ 'layer': '#layerslider .mm-slider-img-2', 'valuexin': '0', 'valueyin': '0' },
			{ 'layer': '#layerslider .mm-slider-img-3', 'valuexin': '0', 'valueyin': '0' },
			{ 'layer': '#layerslider .mm-slider-img-4', 'valuexin': '0', 'valueyin': '0' }
		];
		var layerstart = 0;
		$.each(json, function() {
			//$.each(this, function(name, value) {
				$( json[layerstart].layer ).attr('data-ls', 'offsetxin: ' + json[layerstart].valuexin + '; offsetyin: ' + json[layerstart].valueyin + '; durationin: 3000; delayin: 1000; easingin: easeOutQuart; fadein: true; offsetxout: 0; offsetyout: 0; durationout: 1000; easingout: easeInQuart; fadeout: true; scalexout: 1; scaleyout: 1;');
			//});
			layerstart++;
		});
		// offsetxin: -600;
