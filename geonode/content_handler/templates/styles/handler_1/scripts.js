jQuery(function($) {
    ...
    $(document).ready(function() {
        ...
        *******************************************************/
        ...
        function slider(id) {
            if ($('.section-component .accordion-slider').length) {
                $('#sld-accordion'+id).accordionSlider({
                    width: '100%',
                    height: 420,
                    responsive: true,
                    responsiveMode: 'auto',
    ...
    //                      openPanelOn: 'click',
        ...
        /*******************************************************
            GRID-ACCORDION [INIT]
        *******************************************************/
        // este es el número máximo de ids que puede tener una seccion
var max = "{{is_select}}";
var paso;
for (paso = 0; paso <= max; paso++) {
  // Se ejecuta n veces, con valores desde paso desde 0 hasta max.
  acordion(paso)
  slider(paso)
};
       function acordion(id){
       if ($('.section-component .grid-accordion').length) {
            $('#com_grid-accordion'+id).gridAccordion({
                width: '100%',
                height: 640,
                responsive: true,
                responsiveMode: 'custom',
